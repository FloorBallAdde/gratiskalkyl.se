...
(function(){
  ...
  /* ── 4. Infoga knapp i header/nav ─────────────────────────────────── */
  function inject(){
    /* Prova olika nav-strukturer: ny stil (.site-nav), gammal stil (.header-inner), fallback (header) */
    var nav=document.querySelector('.site-nav')||document.querySelector('.header-inner')||document.querySelector('header');
    if(!nav)return;
